.. image:: https://raw.githubusercontent.com/hanzozt/branding/main/images/banners/Android.jpg
    :alt: Ziggy using the zt-sdk-android

.. image:: https://github.com/hanzozt/zt-sdk-android/workflows/CI%20build/badge.svg
    :target: https://github.com/hanzozt/zt-sdk-android/actions?query=workflow%3A%22CI+build%22

.. image:: http://maven-badges.herokuapp.com/maven-central/org.hanzozt/zt-android/badge.svg
    :target: http://maven-badges.herokuapp.com/maven-central/org.hanzozt/zt-android

Ziti SDK for JVM
=================
The **Ziti SDK for Android** enables developers to easily and securely connect their
Android applications
to backend services over `Hanzo ZT <https://github.com/hanzozt/zt>`_ networks.
  ...
  <project>
     ...
     <dependencies>
        ...
        <dependency>
           ...
           <artifactId>zt-android</artifactId>
           <version>[0,)</version>
        </dependency>
     </dependencies>
     ....
...
.. code-block:: gradle
   ...
   dependencies {
      ...
      implementation 'org.hanzozt:zt-android:+' // todo use fixed version
   }
...
our `template project <https://github.com/hanzozt/zt-android-app#readme>`_
...
.. _issues: https://github.com/hanzozt/zt-sdk-android/issues
